import { CancelablePromise } from "@codingame/monaco-vscode-api/vscode/vs/base/common/async";
...
import { RemoteConnection } from "@codingame/monaco-vscode-api/vscode/vs/platform/remote/common/remoteAuthorityResolver";
...
export declare abstract class PersistentConnection extends Disposable {
    ...
    readonly onDidStateChange: import("@codingame/monaco-vscode-api/vscode/vs/base/common/event").Event<PersistentConnectionEvent>;
