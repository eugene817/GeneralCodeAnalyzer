...
const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: ( localize(9874, 'Contributes terminal functionality.')),
        type: 'object',
        properties: {
            profiles: {
                type: 'array',
                description: ( localize(9875, "Defines additional terminal profiles that the user can create.")),
                items: {
                    type: 'object',
                    required: ['id', 'title'],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: ( localize(9876, "The ID of the terminal profile provider.")),
                            type: 'string',
                        },
                        title: {
                            description: ( localize(9877, "Title for this terminal profile.")),
                            type: 'string',
                        },
                        icon: {
                            ...
                            anyOf: [{
                                ...
                                },
                                {
                                    ...
                                    properties: {
                                        light: {
                                            description: ( localize(9879, 'Icon path when a light theme is used')),
                                            type: 'string'
                                        },
                                        dark: {
                                            description: ( localize(9880, 'Icon path when a dark theme is used')),
                                            type: 'string'
                                        }
                                    }
                                }]
