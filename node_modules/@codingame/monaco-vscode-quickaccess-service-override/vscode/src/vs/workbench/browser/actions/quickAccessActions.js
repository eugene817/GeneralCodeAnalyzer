...
import { inQuickPickContext, defaultQuickAccessContext, getQuickNavigateHandler } from '@codingame/monaco-vscode-7559b0be-bfa5-5fe6-b731-1973fe9fffa1-common/vscode/vs/workbench/browser/quickaccess';
...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2698, "Go to File...")),
            metadata: {
...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(2699, "Quick Open")),
            icon: Codicon.search,
            menu: {
...
class QuickAccessNavigateNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenNavigateNext', ( localize2(2700, 'Navigate Next in Quick Open')), true, true);
    }
}
class QuickAccessNavigatePreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenNavigatePrevious', ( localize2(2701, 'Navigate Previous in Quick Open')), false, true);
    }
}
class QuickAccessSelectNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenSelectNext', ( localize2(2702, 'Select Next in Quick Open')), true, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
...
class QuickAccessSelectPreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenSelectPrevious', ( localize2(2703, 'Select Previous in Quick Open')), false, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
