...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    helpEntries: [{
            description: ( localize(8483, "Show all Quick Access Providers")),
            commandCenterOrder: 70,
            commandCenterLabel: ( localize(8484, 'More'))
        }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: ( localize(8485, "Type the name of a view, output channel or terminal to open.")),
    helpEntries: [{ description: ( localize(8486, "Open View")), commandId: OpenViewPickerAction.ID }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ctor: CommandsQuickAccessProvider,
    prefix: CommandsQuickAccessProvider.PREFIX,
    contextKey: 'inCommandsPicker',
    placeholder: ( localize(8487, "Type the name of a command to run.")),
    helpEntries: [{ description: ( localize(8488, "Show and Run Commands")), commandId: ShowAllCommandsAction.ID, commandCenterOrder: 20 }]
});
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    group: '1_open',
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(8489, "&&Command Palette..."))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarHelpMenu, {
    ...
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(8490, "Show All Commands"))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        ...
        title: ( localize(8492, "Go to &&Line/Column..."))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
    ...
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(8493, "Command Palette..."))
    },
    order: 1
});
