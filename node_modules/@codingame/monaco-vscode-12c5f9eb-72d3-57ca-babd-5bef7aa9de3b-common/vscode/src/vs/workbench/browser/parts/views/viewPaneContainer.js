...
import { LayoutSettings, isHorizontal } from '@codingame/monaco-vscode-81f603ca-d6ea-5402-90dd-3014dffc63b4-common/vscode/vs/workbench/services/layout/browser/layoutService';
...
registerAction2(class MoveViewUp extends MoveViewPosition {
    constructor() {
        super({
            id: 'views.moveViewUp',
            title: ( localize(3459, "Move View Up")),
            keybinding: {
...
registerAction2(class MoveViewLeft extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3460, "Move View Left")),
            keybinding: {
...
registerAction2(class MoveViewDown extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3461, "Move View Down")),
            keybinding: {
...
registerAction2(class MoveViewRight extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3462, "Move View Right")),
            keybinding: {
...
registerAction2(class MoveViews extends Action2 {
    constructor() {
        super({
            id: 'vscode.moveViews',
            title: ( localize(3463, "Move Views")),
        });
    }
