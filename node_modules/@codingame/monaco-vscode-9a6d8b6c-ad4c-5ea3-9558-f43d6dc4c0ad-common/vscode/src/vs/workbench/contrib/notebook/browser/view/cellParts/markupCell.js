...
import { show, hide, append, $, safeInnerHtml, clearNode, reset } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
import { renderIcon } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/iconLabel/iconLabels';
import { raceCancellation, disposableTimeout } from '@codingame/monaco-vscode-api/vscode/vs/base/common/async';
...
import { tokenizeToStringSync } from '@codingame/monaco-vscode-api/vscode/vs/editor/common/languages/textToHtmlTokenizer';
...
let MarkupCell = class MarkupCell extends Disposable {
    ...
    viewUpdateCollapsed() {
        ...
        if (keybinding) {
            element.title = ( localize(8044, "Double-click to expand cell input ({0})", keybinding.getLabel()));
            expandIcon.title = ( localize(8045, "Expand Cell Input ({0})", keybinding.getLabel()));
        }
