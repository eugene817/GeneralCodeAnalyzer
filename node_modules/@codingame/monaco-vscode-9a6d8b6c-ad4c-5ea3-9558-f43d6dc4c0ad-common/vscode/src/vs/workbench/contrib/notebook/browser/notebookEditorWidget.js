...
import './media/notebookChatEditController.css.js';
import './media/notebookChatEditorOverlay.css.js';
import { $ as $$1, getWindow, append, addStandardDisposableGenericMouseDownListener, addStandardDisposableGenericMouseUpListener, trackFocus, runWhenWindowIdle, scheduleAtNextAnimationFrame, size, isAncestorOfActiveElement } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
import { createStyleSheet } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/domStylesheets';
import { mainWindow } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/window';
import { SequencerByKey, DeferredPromise } from '@codingame/monaco-vscode-api/vscode/vs/base/common/async';
...
import { Disposable, DisposableStore, combinedDisposable, dispose, toDisposable } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
import { setTimeout0 } from '@codingame/monaco-vscode-api/vscode/vs/base/common/platform';
import { isEqual, extname } from '@codingame/monaco-vscode-api/vscode/vs/base/common/resources';
...
import { foreground, focusBorder, errorForeground, contrastBorder } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/baseColors';
...
import { scrollbarSliderBackground, scrollbarSliderHoverBackground, scrollbarSliderActiveBackground } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/miscColors';
import '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/quickpickColors';
import '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/searchColors';
import { PANEL_BORDER, SIDE_BAR_BACKGROUND, EDITOR_PANE_BACKGROUND } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/theme';
import { debugIconStartForeground } from '@codingame/monaco-vscode-1bb39316-6fbf-572e-ab6a-818a2496c14f-common/vscode/vs/workbench/contrib/debug/browser/debugColors';
...
import { SelectionStateType, RENDERER_NOT_AVAILABLE, CellKind, NotebookFindScopeType, CellEditType } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookCommon';
import { NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_OUTPUT_FOCUSED, NOTEBOOK_OUTPUT_INPUT_FOCUSED, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_CURSOR_NAVIGATION_MODE } from '@codingame/monaco-vscode-52bb4d5b-ba1a-57fd-9bee-b28824214eac-common/vscode/vs/workbench/contrib/notebook/common/notebookContextKeys';
...
import { PreventDefaultContextMenuItemsContextKeyName } from '@codingame/monaco-vscode-9b5a5e82-d649-5455-b4bf-ef90d6afd294-common/vscode/vs/workbench/contrib/webview/browser/webview.contribution';
...
}, ( localize(7930, "The border color for notebook cells.")));
registerColor('notebook.focusedEditorBorder', focusBorder, ( localize(7931, "The color of the notebook cell editor border.")));
const cellStatusIconSuccess = registerColor('notebookStatusSuccessIcon.foreground', debugIconStartForeground, ( localize(7932, "The error icon color of notebook cells in the cell status bar.")));
...
const cellStatusIconError = registerColor('notebookStatusErrorIcon.foreground', errorForeground, ( localize(7934, "The error icon color of notebook cells in the cell status bar.")));
registerColor('notebookStatusRunningIcon.foreground', foreground, ( localize(7935, "The running icon color of notebook cells in the cell status bar.")));
registerColor('notebook.outputContainerBorderColor', null, ( localize(7936, "The border color of the notebook output container.")));
registerColor('notebook.outputContainerBackgroundColor', null, ( localize(7937, "The color of the notebook output container background.")));
registerColor('notebook.cellToolbarSeparator', {
    dark: ( ( Color.fromHex('#808080')).transparent(0.35)),
    light: ( ( Color.fromHex('#808080')).transparent(0.35)),
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(7938, "The color of the separator in the cell bottom toolbar")));
const focusedCellBackground = registerColor('notebook.focusedCellBackground', null, ( localize(7939, "The background color of a cell when the cell is focused.")));
registerColor('notebook.selectedCellBackground', {
    dark: listInactiveSelectionBackground,
    light: listInactiveSelectionBackground,
    hcDark: null,
    hcLight: null
}, ( localize(7940, "The background color of a cell when the cell is selected.")));
registerColor('notebook.cellHoverBackground', {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(7941, "The background color of a cell when the cell is hovered.")));
...
registerColor('notebook.inactiveSelectedCellBorder', {
    ...
    hcDark: focusBorder,
    hcLight: focusBorder
}, ( localize(7943, "The color of the cell's borders when multiple cells are selected.")));
...
}, ( localize(7946, "The background color of notebook cell status bar items.")));
registerColor('notebook.cellInsertionIndicator', focusBorder, ( localize(7947, "The color of the notebook cell insertion indicator.")));
registerColor('notebookScrollbarSlider.background', scrollbarSliderBackground, ( localize(7948, "Notebook scrollbar slider background color.")));
registerColor('notebookScrollbarSlider.hoverBackground', scrollbarSliderHoverBackground, ( localize(7949, "Notebook scrollbar slider background color when hovering.")));
registerColor('notebookScrollbarSlider.activeBackground', scrollbarSliderActiveBackground, ( localize(7950, "Notebook scrollbar slider background color when clicked on.")));
registerColor('notebook.symbolHighlightBackground', {
    dark: ( Color.fromHex('#ffffff0b')),
    light: ( Color.fromHex('#fdff0033')),
    hcDark: null,
    hcLight: null
}, ( localize(7951, "Background color of highlighted cell")));
registerColor('notebook.cellEditorBackground', {
    light: SIDE_BAR_BACKGROUND,
    dark: SIDE_BAR_BACKGROUND,
    hcDark: null,
    hcLight: null
}, ( localize(7952, "Cell editor background color.")));
const notebookEditorBackground = registerColor('notebook.editorBackground', {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(7953, "Notebook background color.")));
