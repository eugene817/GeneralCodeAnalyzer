...
import { NOTEBOOK_IS_ACTIVE_EDITOR, INTERACTIVE_WINDOW_IS_ACTIVE_EDITOR, REPL_NOTEBOOK_IS_ACTIVE_EDITOR, NOTEBOOK_KERNEL_COUNT, NOTEBOOK_KERNEL_SOURCE_COUNT, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_EDITOR_FOCUSED } from '@codingame/monaco-vscode-52bb4d5b-ba1a-57fd-9bee-b28824214eac-common/vscode/vs/workbench/contrib/notebook/common/notebookContextKeys';
import { isICellRange } from '../../common/notebookRange.js';
import { IEditorService } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/editor/common/editorService.service';
import { isEditorCommandsContext } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
const NOTEBOOK_ACTIONS_CATEGORY = ( localize2(7708, 'Notebook'));
...
MenuRegistry.appendMenuItem(MenuId.NotebookCellTitle, {
    ...
    title: ( localize(7709, "Insert Cell")),
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    ...
    title: ( localize(7710, "Notebook Cell")),
    group: CellOverflowToolbarGroups.Insert,
    when: NOTEBOOK_EDITOR_FOCUSED
});
MenuRegistry.appendMenuItem(MenuId.NotebookCellTitle, {
    title: ( localize(7711, "Share")),
