...
import { StringSHA1, hash } from '@codingame/monaco-vscode-api/vscode/vs/base/common/hash';
...
import { PieceTreeTextBuffer } from '@codingame/monaco-vscode-api/vscode/vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBuffer';
...
class NotebookCellTextModel extends Disposable {
    ...
    get textBuffer() {
        ...
        this._textBuffer = this._register(createTextBuffer(this._source, DefaultEndOfLine.LF).textBuffer);
