import { Emitter, Event, PauseableEmitter } from "@codingame/monaco-vscode-api/vscode/vs/base/common/event";
...
import { CellKind, INotebookFindOptions, NotebookCellOutputsSplice } from "@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookCommon";
...
export declare class CodeCellViewModel extends BaseCellViewModel implements ICellViewModel {
    ...
    readonly executionErrorDiagnostic: import("@codingame/monaco-vscode-api/vscode/vs/base/common/observable").ISettableObservable<ICellExecutionError | undefined, void>;
