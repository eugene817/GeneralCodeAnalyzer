...
import { INotebookFindOptions } from "@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookCommon";
...
import { NotebookPerfMarks } from "@codingame/monaco-vscode-6f9bc782-77e0-5716-93bd-b05210c768c5-common/vscode/vs/workbench/contrib/notebook/common/notebookPerformance";
...
export declare class NotebookEditorWidget extends Disposable implements INotebookEditorDelegate, INotebookEditor {
    ...
    get activeKernel(): import("@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookKernelService").INotebookKernel | undefined;
