...
import { NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_CELL_LINE_NUMBERS } from '@codingame/monaco-vscode-52bb4d5b-ba1a-57fd-9bee-b28824214eac-common/vscode/vs/workbench/contrib/notebook/common/notebookContextKeys';
import { CellContentPart } from '../cellPart.js';
import { NOTEBOOK_EDITOR_ID } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookCommon';
...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    ...
    'properties': {
        'notebook.lineNumbers': {
            ...
            enum: ['off', 'on'],
            default: 'off',
            markdownDescription: ( localize(8020, "Controls the display of line numbers in the cell editor."))
        }
    }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8021, 'Toggle Notebook Line Numbers')),
            ...
            toggled: {
                ...
                title: ( localize(8022, "Notebook Line Numbers")),
            }
        });
    }
    async run(accessor) {
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: ( localize(8023, "Show Cell Line Numbers")),
