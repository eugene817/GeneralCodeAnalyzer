...
import { DeferredPromise, runWhenGlobalIdle } from '@codingame/monaco-vscode-api/vscode/vs/base/common/async';
...
import { Schemas, FileAccess, matchesScheme, matchesSomeScheme } from '@codingame/monaco-vscode-api/vscode/vs/base/common/network';
...
import { isWeb, isMacintosh } from '@codingame/monaco-vscode-api/vscode/vs/base/common/platform';
import { dirname, isEqual, extname, joinPath } from '@codingame/monaco-vscode-api/vscode/vs/base/common/resources';
...
import { editorFindMatch, editorFindMatchHighlight } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/editorColors';
...
import { RendererMessagingSpec, CellUri } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookCommon';
...
import { WebviewOriginStore, WebviewContentPurpose } from '@codingame/monaco-vscode-7ba0af96-90c2-5e11-ad7f-befdbbf246c8-common/vscode/vs/workbench/contrib/webview/browser/webview';
...
import { webviewGenericCspSource, asWebviewUri } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/webview/common/webview';
...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            'notebook-cell-markup-empty-content': ( localize(8046, "Empty markdown cell, double-click or press enter to edit.")),
            'notebook-cell-renderer-not-found-error': ( localize(8047, "No renderer found for '$0'")),
            'notebook-cell-renderer-fallbacks-exhausted': ( localize(8048, "Could not render content for '$0'")),
    ...
    _createInset(webviewService, content) {
        ...
        const webview = webviewService.createWebviewElement({
            ...
            title: ( localize(8049, "Notebook webview content")),
            options: {
