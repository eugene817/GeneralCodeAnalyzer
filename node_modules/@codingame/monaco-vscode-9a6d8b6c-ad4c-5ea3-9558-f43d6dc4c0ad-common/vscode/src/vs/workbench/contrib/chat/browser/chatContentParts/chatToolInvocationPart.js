...
import { ChatProgressContentPart, ChatCustomProgressPart } from './chatProgressContentPart.js';
...
let ChatToolInvocationSubPart = class ChatToolInvocationSubPart extends Disposable {
    ...
    constructor(toolInvocation, context, renderer, listPool, editorPool, currentWidthDelegate, codeBlockModelCollection, codeBlockStartIndex, instantiationService, keybindingService, modelService, languageService, contextKeyService) {
        super();
    ...
    createConfirmationWidget(toolInvocation) {
        ...
        const continueLabel = ( localize(4509, "Continue"));
        ...
        const cancelLabel = ( localize(4510, "Cancel"));
        ...
        if (typeof message === 'string') {
            ...
            confirmWidget = this._register(this.instantiationService.createInstance(ChatCustomConfirmationWidget, title, this.markdownPart.domNode, buttons));
        }
    ...
    createTerminalConfirmationWidget(toolInvocation, terminalData) {
        ...
        const element = $('');
        append(element, editor.object.element);
        append(element, renderedMessage.element);
        const confirmWidget = this._register(this.instantiationService.createInstance(ChatCustomConfirmationWidget, title, element, buttons));
