...
import { NOTEBOOK_IS_ACTIVE_EDITOR, NOTEBOOK_EDITOR_FOCUSED } from '@codingame/monaco-vscode-52bb4d5b-ba1a-57fd-9bee-b28824214eac-common/vscode/vs/workbench/contrib/notebook/common/notebookContextKeys';
...
const NOTEBOOK_FOLD_COMMAND_LABEL = ( localize(7750, "Fold Cell"));
const NOTEBOOK_UNFOLD_COMMAND_LABEL = ( localize2(7751, "Unfold Cell"));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'notebook.fold',
            title: ( localize2(7750, "Fold Cell")),
