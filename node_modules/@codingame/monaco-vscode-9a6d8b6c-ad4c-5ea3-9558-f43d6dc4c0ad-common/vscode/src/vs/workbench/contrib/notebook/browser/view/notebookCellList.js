...
import { scheduleAtNextAnimationFrame, getWindow, isAncestorOfActiveElement, findParentWithClass } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
import { createStyleSheet } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/domStylesheets';
import { ListError } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/list/list';
...
import { NOTEBOOK_EDITOR_CURSOR_BOUNDARY, NOTEBOOK_EDITOR_CURSOR_LINE_BOUNDARY, diff, CellKind, SelectionStateType } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookCommon';
import { cellRangesEqual, cellRangesToIndexes, reduceCellRanges } from '../../common/notebookRange.js';
import { NOTEBOOK_CELL_LIST_FOCUSED } from '@codingame/monaco-vscode-52bb4d5b-ba1a-57fd-9bee-b28824214eac-common/vscode/vs/workbench/contrib/notebook/common/notebookContextKeys';
            ...
            if (this._webviewElement) {
                Event.once(this.view.onWillScroll)(() => {
                    ...
                    if (validateWebviewBoundary(this._webviewElement.domNode)) {
                        ...
                        this._webviewElement.setTop(-5e3);
                    }
                });
            }
