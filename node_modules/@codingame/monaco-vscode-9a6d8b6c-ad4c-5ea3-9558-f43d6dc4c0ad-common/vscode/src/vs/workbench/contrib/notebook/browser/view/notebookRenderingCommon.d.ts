...
import { IListContextMenuEvent, IListEvent, IListMouseEvent } from "@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/list/list";
...
import { IWorkbenchListOptionsUpdate } from "@codingame/monaco-vscode-api/vscode/vs/platform/list/browser/listService";
