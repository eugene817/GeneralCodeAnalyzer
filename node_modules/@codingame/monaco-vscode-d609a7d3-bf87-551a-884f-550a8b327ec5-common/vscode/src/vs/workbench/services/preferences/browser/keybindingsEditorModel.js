...
const SOURCE_SYSTEM = ( localize(12025, "System"));
const SOURCE_EXTENSION = ( localize(12026, "Extension"));
const SOURCE_USER = ( localize(12027, "User"));
    ...
    static getCommandDefaultLabel(menuCommand) {
        if (!Language.isDefaultVariant()) {
            if (menuCommand && menuCommand.title && menuCommand.title.original) {
                ...
                return category ? ( localize(12028, "{0}: {1}", category, title)) : title;
            }
        }
        return null;
    }
...
class KeybindingItemMatches {
    ...
    wordMatchesAltModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(12029, "option")), word)) {
            return true;
        }
        return false;
    }
    ...
    wordMatchesMetaModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(12030, "meta")), word)) {
            return true;
        }
        return false;
    }
