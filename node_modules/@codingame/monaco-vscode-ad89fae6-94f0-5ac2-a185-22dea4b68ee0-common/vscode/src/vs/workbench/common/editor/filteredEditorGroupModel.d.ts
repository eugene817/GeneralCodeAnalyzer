import { IUntypedEditorInput, IMatchEditorOptions, EditorsOrder, GroupIdentifier } from "@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor";
...
declare abstract class FilteredEditorGroupModel extends Disposable implements IReadonlyEditorGroupModel {
    ...
    readonly onDidModelChange: import("@codingame/monaco-vscode-api/vscode/vs/base/common/event").Event<IGroupModelChangeEvent>;
