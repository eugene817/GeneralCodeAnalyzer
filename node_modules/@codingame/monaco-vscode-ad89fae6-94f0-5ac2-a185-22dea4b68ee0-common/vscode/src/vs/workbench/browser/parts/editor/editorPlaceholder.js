...
import { computeEditorAriaLabel, EditorPaneDescriptor } from '@codingame/monaco-vscode-12c5f9eb-72d3-57ca-babd-5bef7aa9de3b-common/vscode/vs/workbench/browser/editor';
...
let WorkspaceTrustRequiredPlaceholderEditor = class WorkspaceTrustRequiredPlaceholderEditor extends EditorPlaceholder {
    ...
    static { this.LABEL = ( localize(3187, "Workspace Trust Required")); }
    ...
    async getContents() {
        return {
            ...
            actions: [
                {
                    label: ( localize(3190, "Manage Workspace Trust")),
...
let ErrorPlaceholderEditor = class ErrorPlaceholderEditor extends EditorPlaceholder {
    ...
    static { this.LABEL = ( localize(3191, "Error Editor")); }
    ...
    async getContents(input, options, disposables) {
        ...
        let label;
        if (isFileNotFound) {
            label = ( localize(3192, "The editor could not be opened because the file was not found."));
        }
            ...
            label = ( localize(3194, "The editor could not be opened due to an unexpected error."));
        }
        let icon = '$(error)';
