...
import { computeEditorAriaLabel } from '@codingame/monaco-vscode-12c5f9eb-72d3-57ca-babd-5bef7aa9de3b-common/vscode/vs/workbench/browser/editor';
...
import { EditorTabsControl, EditorCommandsContextActionRunner } from '@codingame/monaco-vscode-2e69e120-617a-5258-95e0-3b8902f4e014-common/vscode/vs/workbench/browser/parts/editor/editorTabsControl';
...
import { DraggedEditorGroupIdentifier, DraggedEditorIdentifier, isWindowDraggedOver, extractTreeDropData, ResourcesDropHandler } from '@codingame/monaco-vscode-81f603ca-d6ea-5402-90dd-3014dffc63b4-common/vscode/vs/workbench/browser/dnd';
...
import { UNLOCK_GROUP_COMMAND_ID } from '@codingame/monaco-vscode-38f25ab8-ea30-5ba9-8a08-ae3308c297c0-common/vscode/vs/workbench/browser/parts/editor/editorCommands';
...
let MultiEditorTabsControl = class MultiEditorTabsControl extends EditorTabsControl {
    ...
    createTab(tabIndex, tabsContainer, tabsScrollbar) {
        ...
        const tabActionBar = ( new ActionBar(tabActionsContainer, { ariaLabel: ( localize(3260, "Tab actions")), actionRunner: tabActionRunner }));
