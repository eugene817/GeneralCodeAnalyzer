...
import { PlatformToString, Platform, isSafari, isChrome, isEdge, isFirefox, isAndroid, isWeb, platform } from '@codingame/monaco-vscode-api/vscode/vs/base/common/platform';
