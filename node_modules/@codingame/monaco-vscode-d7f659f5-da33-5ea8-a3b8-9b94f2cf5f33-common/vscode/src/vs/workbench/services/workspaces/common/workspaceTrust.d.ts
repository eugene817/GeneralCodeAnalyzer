...
import { WorkspaceTrustRequestOptions, IWorkspaceTrustUriInfo, IWorkspaceTrustTransitionParticipant, WorkspaceTrustUriResponse } from "@codingame/monaco-vscode-api/vscode/vs/platform/workspace/common/workspaceTrust";
