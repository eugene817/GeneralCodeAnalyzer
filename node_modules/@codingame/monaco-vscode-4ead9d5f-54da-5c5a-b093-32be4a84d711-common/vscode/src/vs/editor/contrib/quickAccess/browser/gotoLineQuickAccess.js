...
class AbstractGotoLineQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        const label = ( localize(1362, "Open a text editor first to go to a line."));
        picker.items = [{ label }];
    ...
    getPickLabel(editor, lineNumber, column) {
        if (this.isValidLineNumber(editor, lineNumber)) {
            if (this.isValidColumn(editor, lineNumber, column)) {
                return localize(1363, "Go to line {0} and character {1}.", lineNumber, column);
            }
            return localize(1364, "Go to line {0}.", lineNumber);
        }
