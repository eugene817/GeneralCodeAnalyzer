...
import { ExplorerFindProviderActive, UndoConfirmLevel } from '@codingame/monaco-vscode-a4c2011e-8775-52bd-abf0-4a3c07a9696b-common/vscode/vs/workbench/contrib/files/common/files';
...
import { ExplorerItem, NewExplorerItem } from '@codingame/monaco-vscode-c4e2825a-b5b1-5f0e-b547-068c32e06d50-common/vscode/vs/workbench/contrib/files/common/explorerModel';
...
import { explorerFileContribRegistry } from '@codingame/monaco-vscode-a4c2011e-8775-52bd-abf0-4a3c07a9696b-common/vscode/vs/workbench/contrib/files/browser/explorerFileContrib';
...
let FilesRenderer = class FilesRenderer {
    ...
    getWidgetAriaLabel() {
        return localize(6931, "Files Explorer");
    }
    get templateId() {
    ...
    renderStat(stat, label, domId, filterData, templateData) {
        ...
        if (highlightResults > 0) {
            ...
            badge.setTitleFormat(( localize(6932, "Directory contains {0} matches", highlightResults)));
    ...
    renderInputBox(container, stat, editableData) {
        ...
        const inputBox = ( new InputBox(label.element, this.contextViewService, {
            ...
            ariaLabel: ( localize(6933, "Type file name. Press Enter to confirm or Escape to cancel.")),
...
let FileDragAndDrop = class FileDragAndDrop {
    ...
    async handleExplorerDrop(data, target, targetIndex, targetSector, originalEvent) {
        ...
        if (confirmDragAndDrop) {
            ...
            const confirmation = await this.dialogService.confirm({
                ...
                detail,
                checkbox: {
                    label: ( localize(6938, "Do not ask me again"))
                },
                primaryButton: ( localize(6939, "&&Move"))
            });
    ...
    async doHandleExplorerDropOnCopy(sources, target) {
        ...
        await this.explorerService.applyBulkEdit(resourceFileEdits, {
            ...
            undoLabel: ( localize(6940, "Copy {0}", labelSuffix)),
            progressLabel: ( localize(6941, "Copying {0}", labelSuffix)),
        });
    ...
    async doHandleExplorerDropOnMove(sources, target) {
        ...
        const options = {
            ...
            undoLabel: ( localize(6942, "Move {0}", labelSuffix)),
            progressLabel: ( localize(6943, "Moving {0}", labelSuffix))
        };
        try {
...
function getFileOrFolderLabelSuffix(items) {
    ...
    if (items.every(i => i.isDirectory)) {
        return localize(6944, "{0} folders", items.length);
    }
    if (items.every(i => !i.isDirectory)) {
        return localize(6945, "{0} files", items.length);
    }
