...
let PaneCompositeBar = class PaneCompositeBar extends Disposable {
    ...
    getContextMenuActionsForComposite(compositeId) {
        ...
        actions.push(( new SubmenuAction('moveToMenu', ( localize(3342, "Move To")), moveActions)));
        if (defaultLocation !== currentLocation) {
            actions.push(toAction({
                id: 'resetLocationAction', label: ( localize(3343, "Reset Location")), run: () => {
    ...
    createMoveAction(viewContainer, newLocation, defaultLocation) {
        return toAction({
            ...
            label: newLocation === ViewContainerLocation.Panel ? ( localize(3344, "Panel")) : newLocation === ViewContainerLocation.Sidebar ? ( localize(3345, "Primary Side Bar")) : ( localize(3346, "Secondary Side Bar")),
            run: () => {
                let index;
