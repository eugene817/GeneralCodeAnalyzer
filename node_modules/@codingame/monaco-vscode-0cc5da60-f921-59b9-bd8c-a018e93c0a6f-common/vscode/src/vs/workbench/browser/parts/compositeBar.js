...
import { toggleDropEffect, CompositeDragAndDropObserver } from '@codingame/monaco-vscode-81f603ca-d6ea-5402-90dd-3014dffc63b4-common/vscode/vs/workbench/browser/dnd';
...
let CompositeBar = class CompositeBar extends Widget {
    ...
    create(parent) {
        ...
        this.compositeSwitcherBar = this._register(( new ActionBar(actionBarDiv, {
            ...
            ariaLabel: ( localize(2804, "Active View Switcher")),
            ariaRole: 'tablist',
