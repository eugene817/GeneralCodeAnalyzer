...
const ADD_ROOT_FOLDER_LABEL = ( localize2(2758, 'Add Folder to Workspace...'));
...
async function selectWorkspaceFolders(accessor) {
    ...
    const folders = await dialogsService.showOpenDialog({
        openLabel: mnemonicButtonLabel(( localize(2759, "&&Add"))),
        title: ( localize(2760, "Add Folder to Workspace")),
...
CommandsRegistry.registerCommand(PICK_WORKSPACE_FOLDER_COMMAND_ID, async function (accessor, args) {
    ...
    if (!options.placeHolder) {
        options.placeHolder = ( localize(2761, "Select workspace folder"));
    }
