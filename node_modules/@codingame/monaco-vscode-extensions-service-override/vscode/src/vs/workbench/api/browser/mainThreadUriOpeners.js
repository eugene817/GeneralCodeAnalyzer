            ...
            openExternalUri: async (uri, ctx, token) => {
                try {
                    ...
                    if (!isCancellationError(e)) {
                        const openDefaultAction = ( new Action('default', ( localize(2382, "Open using default opener")), undefined, undefined, async () => {
                        ...
                        this.notificationService.notify({
                            ...
                            message: ( localize(2383, 'Could not open uri with \'{0}\': {1}', id, (e.toString()))),
                            actions: {
                                primary: [
                                    openDefaultAction
                                ]
