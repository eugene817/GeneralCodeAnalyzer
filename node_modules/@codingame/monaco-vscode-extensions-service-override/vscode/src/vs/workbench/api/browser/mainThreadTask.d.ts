...
import { ITaskExecutionDTO, ITaskDTO, ITaskHandleDTO, ITaskFilterDTO, ITaskSystemInfoDTO } from "@codingame/monaco-vscode-api/vscode/vs/workbench/api/common/shared/tasks";
