...
import { isFullscreen } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/browser';
import { $ as $$1, ModifierKeyEmitter, addDisposableListener, EventType, getWindow, isAncestor, scheduleAtNextAnimationFrame, getDomNodeZoomLevel } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
...
import { cleanMnemonic, MENU_MNEMONIC_REGEX, HorizontalDirection, MENU_ESCAPED_MNEMONIC_REGEX, VerticalDirection, Menu } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/menu/menu';
import { ActionRunner, SubmenuAction, Separator } from '@codingame/monaco-vscode-api/vscode/vs/base/common/actions';
...
import { KeyCode, KeyMod, ScanCodeUtils, ScanCode } from '@codingame/monaco-vscode-api/vscode/vs/base/common/keyCodes';
...
import { escape, ltrim, rtrim } from '@codingame/monaco-vscode-api/vscode/vs/base/common/strings';
