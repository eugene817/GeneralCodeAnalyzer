...
import { ResourceLabelFormatter } from "@codingame/monaco-vscode-7559b0be-bfa5-5fe6-b731-1973fe9fffa1-common/vscode/vs/platform/label/common/label";
...
export interface MainThreadWorkspaceShape extends IDisposable {
    ...
    $decode(content: VSBuffer, resource: UriComponents | undefined, options?: {
        encoding?: string;
    }): Promise<string>;
    $encode(content: string, resource: UriComponents | undefined, options?: {
        encoding?: string;
    }): Promise<VSBuffer>;
}
