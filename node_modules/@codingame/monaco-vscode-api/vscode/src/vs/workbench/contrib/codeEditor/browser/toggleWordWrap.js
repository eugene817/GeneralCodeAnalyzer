...
const EDITOR_WORD_WRAP = ( new RawContextKey('editorWordWrap', false, ( localize(4968, 'Whether the editor is currently using word wrapping.'))));
...
class ToggleWordWrapAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(4969, "View: Toggle Word Wrap")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(4970, "Disable wrapping for this file")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(4971, "Enable wrapping for this file")),
        icon: Codicon.wordWrap
    },
    group: 'navigation',
    order: 1,
