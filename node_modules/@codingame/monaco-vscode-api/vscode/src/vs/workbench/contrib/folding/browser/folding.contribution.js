...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(( localize(6974, 'All')));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(( localize(6975, "All active folding range providers")));
