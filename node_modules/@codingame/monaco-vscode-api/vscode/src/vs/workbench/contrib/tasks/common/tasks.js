...
const TASK_RUNNING_STATE = ( new RawContextKey('taskRunning', false, ( localize(9672, "Whether a task is currently running."))));
const TASK_TERMINAL_ACTIVE = ( new RawContextKey('taskTerminalActive', false, ( localize(9673, "Whether the active terminal is a task terminal."))));
const TASKS_CATEGORY = ( localize2(9674, "Tasks"));
var ShellQuoting;
