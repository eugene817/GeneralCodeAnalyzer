...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: ( localize(12077, 'The ID of a Get Started walkthrough to open.')),
            type: 'string'
        },
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(12078, 'Contributes help information for Remote')),
        type: 'object',
        properties: {
            'getStarted': {
            ...
            'feedback': {
                ...
                type: 'string',
                markdownDeprecationMessage: ( localize(12082, "Use {0} instead", '`reportIssue`'))
            },
            'reportIssue': {
                description: ( localize(
                    12083,
