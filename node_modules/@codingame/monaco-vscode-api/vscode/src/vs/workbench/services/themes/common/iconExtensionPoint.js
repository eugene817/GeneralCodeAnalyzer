...
const iconConfigurationExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(12238, 'Contributes extension defined themable icons')),
        type: 'object',
        propertyNames: {
            pattern: iconIdPattern,
            description: ( localize(12239, 'The identifier of the themable icon')),
        ...
        additionalProperties: {
            ...
            properties: {
                description: {
                    type: 'string',
                    description: ( localize(12241, 'The description of the themable icon')),
                },
                default: {
                    anyOf: [
                        iconReferenceSchema,
                        {
                            ...
                            properties: {
                                fontPath: {
                                    description: ( localize(12242, 'The path of the icon font that defines the icon.')),
                                    type: 'string'
                                },
                                fontCharacter: {
                                    description: ( localize(12243, 'The character for the icon in the icon font.')),
                                    type: 'string'
                                }
                            },
