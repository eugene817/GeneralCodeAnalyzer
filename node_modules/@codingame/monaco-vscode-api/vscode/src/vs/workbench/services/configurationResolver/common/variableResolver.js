...
class AbstractVariableResolverService {
    ...
    async evaluateSingleVariable(environment, match, variable, folderUri, commandValueMapping) {
        ...
        const getFilePath = (variableKind) => {
            ...
            throw ( new VariableError(variableKind, ( localize(11663, "Variable {0} can not be resolved. Please open an editor.", match))));
        };
        ...
        const getFolderUri = (variableKind) => {
            ...
            throw ( new VariableError(variableKind, ( localize(11667, "Variable {0} can not be resolved. Please open a folder.", match))));
        };
        switch (variable) {
            case 'env':
                if (argument) {
