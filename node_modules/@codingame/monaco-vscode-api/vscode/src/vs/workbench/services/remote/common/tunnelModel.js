...
const forwardedPortsFeaturesEnabled = ( new RawContextKey('forwardedPortsViewEnabled', false, ( localize(12085, "Whether the Ports view is enabled."))));
const forwardedPortsViewEnabled = ( new RawContextKey('forwardedPortsViewOnlyEnabled', false, ( localize(12085, "Whether the Ports view is enabled."))));
...
const UserTunnelSource = {
    ...
    description: ( localize(12086, "User Forwarded"))
};
const AutoTunnelSource = {
    source: TunnelSource.Auto,
    description: ( localize(12087, "Auto Forwarded"))
};
            ...
            for (const tunnel of tunnels) {
                ...
                this.detected.set(makeAddress(tunnel.remoteAddress.host, tunnel.remoteAddress.port), {
                    ...
                    source: {
                        ...
                        description: ( localize(12089, "Statically Forwarded"))
                    }
                });
