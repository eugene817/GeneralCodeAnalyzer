...
import type { IHoverOptions, IHoverWidget, IManagedHoverContentOrFactory } from "@codingame/monaco-vscode-view-status-bar-service-override/vscode/vs/base/browser/ui/hover/hover";
