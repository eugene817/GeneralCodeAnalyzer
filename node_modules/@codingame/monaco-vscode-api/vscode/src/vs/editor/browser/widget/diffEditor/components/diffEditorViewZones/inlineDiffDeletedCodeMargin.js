                ...
                getActions: () => {
                    ...
                    actions.push(( new Action('diff.clipboard.copyDeletedContent', isDeletion
                        ? (_diff.original.length > 1
                            ? ( localize(176, "Copy deleted lines"))
                            : ( localize(177, "Copy deleted line")))
                        : (_diff.original.length > 1
                            ? ( localize(178, "Copy changed lines"))
                            : ( localize(179, "Copy changed line"))), undefined, true, async () => {
                    ...
                    if (!readOnly) {
                        actions.push(( new Action('diff.inline.revertChange', ( localize(182, "Revert this change")), undefined, true, async () => {
