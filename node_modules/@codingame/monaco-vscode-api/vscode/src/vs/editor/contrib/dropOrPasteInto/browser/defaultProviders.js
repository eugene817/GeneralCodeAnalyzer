...
class DefaultTextPasteOrDropEditProvider extends SimplePasteAndDropProvider {
    ...
    async getEdit(dataTransfer, _token) {
        ...
        return {
            ...
            title: ( localize(959, "Insert Plain Text")),
            insertText,
            kind: this.kind,
        };
    }
    ...
    async getEdit(dataTransfer, token) {
        ...
        if (uriCount > 0) {
            label = entries.length > 1
                ? ( localize(960, "Insert Uris"))
                : ( localize(961, "Insert Uri"));
        }
        else {
            label = entries.length > 1
                ? ( localize(962, "Insert Paths"))
                : ( localize(963, "Insert Path"));
        }
        return {
    ...
    async getEdit(dataTransfer, token) {
        ...
        return {
            ...
            title: entries.length > 1
                ? ( localize(964, "Insert Relative Paths"))
                : ( localize(965, "Insert Relative Path")),
            kind: this.kind,
        };
    }
};
    ...
    async provideDocumentPasteEdits(_model, _ranges, dataTransfer, context, token) {
        ...
        return {
            ...
            edits: [{
                    ...
                    title: ( localize(966, 'Insert HTML')),
                    kind: this.kind,
                }],
        };
    }
