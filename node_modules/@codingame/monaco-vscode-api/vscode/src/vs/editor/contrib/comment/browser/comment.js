...
class ToggleCommentLineAction extends CommentLineAction {
    constructor() {
        super(Type.Toggle, {
            ...
            label: ( localize2(928, "Toggle Line Comment")),
            ...
            menuOpts: {
                ...
                group: '5_insert',
                title: ( localize(929, "&&Toggle Line Comment")),
                order: 1
            }
        });
    }
...
class AddLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceAdd, {
            ...
            label: ( localize2(930, "Add Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceRemove, {
            ...
            label: ( localize2(931, "Remove Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class BlockCommentAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(932, "Toggle Block Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarEditMenu,
                group: '5_insert',
                title: ( localize(933, "Toggle &&Block Comment")),
                order: 2
            }
        });
    }
