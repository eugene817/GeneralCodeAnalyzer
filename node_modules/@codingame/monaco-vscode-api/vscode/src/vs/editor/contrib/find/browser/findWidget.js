...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, ( localize(988, 'Icon to indicate that the editor find widget is collapsed.')));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, ( localize(989, 'Icon to indicate that the editor find widget is expanded.')));
const findSelectionIcon = registerIcon('find-selection', Codicon.selection, ( localize(990, 'Icon for \'Find in Selection\' in the editor find widget.')));
const findReplaceIcon = registerIcon('find-replace', Codicon.replace, ( localize(991, 'Icon for \'Replace\' in the editor find widget.')));
const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, ( localize(992, 'Icon for \'Replace All\' in the editor find widget.')));
const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, ( localize(993, 'Icon for \'Find Previous\' in the editor find widget.')));
const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, ( localize(994, 'Icon for \'Find Next\' in the editor find widget.')));
const NLS_FIND_DIALOG_LABEL = ( localize(995, "Find / Replace"));
const NLS_FIND_INPUT_LABEL = ( localize(996, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(997, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(998, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(999, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(1000, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(1001, "Close"));
const NLS_REPLACE_INPUT_LABEL = ( localize(1002, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(1003, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(1004, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(1005, "Replace All"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(1006, "Toggle Replace"));
...
const NLS_MATCHES_LOCATION = ( localize(1008, "{0} of {1}"));
const NLS_NO_RESULTS = ( localize(1009, "No results"));
...
class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? ( localize(1010, "{0} found", label))
                : ( localize(1011, "{0} found for '{1}'", label, searchString));
        }
        if (currentMatch) {
        ...
        return localize(1013, "{0} found for '{1}'", label, searchString);
    }
