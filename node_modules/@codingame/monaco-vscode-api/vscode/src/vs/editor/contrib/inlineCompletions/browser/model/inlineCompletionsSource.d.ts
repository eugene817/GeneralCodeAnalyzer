...
export declare class InlineCompletionsSource extends Disposable {
    ...
    constructor(_textModel: ITextModel, _versionId: IObservableWithChange<number | null, IModelContentChangedEvent | undefined>, _debounceValue: IFeatureDebounceInformation, _languageFeaturesService: ILanguageFeaturesService, _languageConfigurationService: ILanguageConfigurationService, _logService: ILogService, _configurationService: IConfigurationService, _instantiationService: IInstantiationService);
    private _log;
    private readonly _loadingCount;
    readonly loading: IObservable<boolean>;
    fetch(position: Position, context: InlineCompletionContext, activeInlineCompletion: InlineCompletionWithUpdatedRange | undefined, withDebounce: boolean): Promise<boolean>;
...
export declare class UpToDateInlineCompletions implements IDisposable {
    ...
    constructor(inlineCompletionProviderResult: InlineCompletionProviderResult, request: UpdateRequest, _textModel: ITextModel, _versionId: IObservableWithChange<number | null, IModelContentChangedEvent | undefined>);
    clone(): this;
    dispose(): void;
    prepend(inlineCompletion: InlineCompletionItem, range: Range, addRefToSource: boolean): void;
}
export declare class InlineCompletionWithUpdatedRange extends Disposable {
    ...
    private _updatedEdit;
    get updatedEdit(): IObservable<OffsetEdit | undefined>;
    ...
    constructor(inlineCompletion: InlineCompletionItem, updatedRange: Range | undefined, _textModel: ITextModel, _modelVersion: IObservableWithChange<number | null, IModelContentChangedEvent | undefined>, request: UpdateRequest);
    private _toInlineCompletionEdit;
    private _toUpdatedEdit;
