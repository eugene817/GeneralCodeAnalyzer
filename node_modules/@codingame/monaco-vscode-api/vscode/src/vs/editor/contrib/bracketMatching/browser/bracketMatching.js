...
const overviewRulerBracketMatchForeground = registerColor('editorOverviewRuler.bracketMatchForeground', '#A0A0A0', ( localize(845, 'Overview ruler marker color for matching brackets.')));
class JumpToBracketAction extends EditorAction {
    constructor() {
        super({
            id: 'editor.action.jumpToBracket',
            label: ( localize2(846, "Go to Bracket")),
...
class SelectToBracketAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(847, "Select to Bracket")),
            precondition: undefined,
            metadata: {
                description: ( localize2(848, "Select the text inside and including the brackets or curly braces")),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
...
class RemoveBracketsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(849, "Remove Brackets")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: 'editor.action.jumpToBracket',
        title: ( localize(850, "Go to &&Bracket"))
    },
    order: 2
});
