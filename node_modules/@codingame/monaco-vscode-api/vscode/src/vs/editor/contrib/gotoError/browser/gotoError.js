...
class NextMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = ( localize2(1049, "Go to Next Problem (Error, Warning, Info)")); }
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-next', Codicon.arrowDown, ( localize(1050, 'Icon for goto next marker.'))),
                group: 'navigation',
                order: 1
            }
        });
...
class PrevMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = ( localize2(1051, "Go to Previous Problem (Error, Warning, Info)")); }
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, ( localize(1052, 'Icon for goto previous marker.'))),
                group: 'navigation',
                order: 2
            }
        });
...
class NextMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(true, true, {
            ...
            label: ( localize2(1053, "Go to Next Problem in Files (Error, Warning, Info)")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary: KeyCode.F8,
            ...
            menuOpts: {
                ...
                title: ( localize(1054, "Next &&Problem")),
                group: '6_problem_nav',
                order: 1
            }
        });
...
class PrevMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(false, true, {
            ...
            label: ( localize2(1055, "Go to Previous Problem in Files (Error, Warning, Info)")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarGoMenu,
                title: ( localize(1056, "Previous &&Problem")),
                group: '6_problem_nav',
                order: 2
            }
        });
