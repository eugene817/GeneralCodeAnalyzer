...
class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1072, 'Definitions')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1073, "No definition found for '{0}'", info.word))
            : ( localize(1074, "No definition found"));
    }
...
registerAction2(class GoToDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1075, "Go to Definition")),
                mnemonicTitle: ( localize(1076, "Go to &&Definition")),
            },
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1079, 'Declarations')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1080, "No declaration found for '{0}'", info.word))
            : ( localize(1081, "No declaration found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1082, "Go to Declaration")),
                mnemonicTitle: ( localize(1083, "Go to &&Declaration")),
            },
...
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: ( localize2(1084, "Peek Declaration")),
            precondition: ( ContextKeyExpr.and(
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1085, 'Type Definitions')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1086, "No type definition found for '{0}'", info.word))
            : ( localize(1087, "No type definition found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1088, "Go to Type Definition")),
                mnemonicTitle: ( localize(1089, "Go to &&Type Definition")),
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1090, "Peek Type Definition")),
            precondition: ( ContextKeyExpr.and(
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1091, 'Implementations')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1092, "No implementation found for '{0}'", info.word))
            : ( localize(1093, "No implementation found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1094, "Go to Implementations")),
                mnemonicTitle: ( localize(1095, "Go to &&Implementations")),
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1096, "Peek Implementations")),
            precondition: ( ContextKeyExpr.and(
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info
            ? ( localize(1097, "No references found for '{0}'", info.word))
            : ( localize(1098, "No references found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1099, "Go to References")),
                mnemonicTitle: ( localize(1100, "Go to &&References")),
            },
            precondition: ( ContextKeyExpr.and(
...
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: ( localize2(1102, "Peek References")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.hasReferenceProvider,
                PeekContext.notInPeekEditor,
                ( EditorContextKeys.isInEmbeddedEditor.toNegated())
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: ( localize2(1103, "Go to Any Symbol")),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return (new ReferencesModel(this._references, localize(1104, 'Locations')));
    }
    _getNoResultFoundMessage(info) {
        return info && ( localize(1105, "No results for '{0}'", info.word)) || '';
    }
    _getGoToPreference(editor) {
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(languageFeaturesService.referenceProvider, control.getModel(), Position.lift(position), false, false, token).then(references => ( new ReferencesModel(references, ( localize(1101, 'References'))))));
