                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = ( localize(1502, '{0} {1}, {2}', label, detail, description));
                        }
                        else if (detail) {
                            label = ( localize(1503, '{0} {1}', label, detail));
                        }
                        else if (description) {
                            label = ( localize(1504, '{0}, {1}', label, description));
                        }
                    }
                    ...
                    return localize(1505, "{0}, docs: {1}", label, docs);
                },
            }
        }));
