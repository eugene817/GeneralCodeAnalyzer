...
export declare class InlineCompletionsModel extends Disposable {
    ...
    readonly warning: IObservable<import("../../../../common/languages.js").InlineCompletionWarning | undefined>;
    ...
    private _acceptNext;
    private readonly _inAcceptPartialFlow;
    readonly inAcceptPartialFlow: IObservable<boolean>;
    acceptNextInlineEditPart(editor: ICodeEditor): Promise<void>;
    ...
    jump(): void;
    handleInlineEditShown(inlineCompletion: InlineCompletionItem): Promise<void>;
}
interface Repro {
