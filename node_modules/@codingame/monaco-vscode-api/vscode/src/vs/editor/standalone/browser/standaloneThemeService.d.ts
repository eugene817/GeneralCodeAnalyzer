...
import { IFileIconTheme, IProductIconTheme, IThemeChangeEvent } from "../../../platform/theme/common/themeService.js";
...
export declare class StandaloneThemeService extends Disposable implements IStandaloneThemeService {
    ...
    readonly onDidColorThemeChange: import("../../../base/common/event.js").Event<IThemeChangeEvent>;
