...
const editorLineHighlight = registerColor('editor.lineHighlightBackground', null, ( localize(645, 'Background color for the highlight of line at the cursor position.')));
...
registerColor('editor.rangeHighlightBorder', { dark: null, light: null, hcDark: activeContrastBorder, hcLight: activeContrastBorder }, ( localize(648, 'Background color of the border around highlighted ranges.')));
...
registerColor('editor.symbolHighlightBorder', { dark: null, light: null, hcDark: activeContrastBorder, hcLight: activeContrastBorder }, ( localize(650, 'Background color of the border around highlighted symbols.')));
const editorCursorForeground = registerColor('editorCursor.foreground', { dark: '#AEAFAD', light: Color.black, hcDark: Color.white, hcLight: '#0F4A85' }, ( localize(651, 'Color of the editor cursor.')));
...
const editorWhitespaces = registerColor('editorWhitespace.foreground', { dark: '#e3e4e229', light: '#33333333', hcDark: '#e3e4e229', hcLight: '#CCCCCC' }, ( localize(657, 'Color of whitespace characters in the editor.')));
const editorLineNumbers = registerColor('editorLineNumber.foreground', { dark: '#858585', light: '#237893', hcDark: Color.white, hcLight: '#292929' }, ( localize(658, 'Color of editor line numbers.')));
const deprecatedEditorIndentGuides = registerColor('editorIndentGuide.background', editorWhitespaces, ( localize(659, 'Color of the editor indentation guides.')), false, ( localize(
 660,
 '\'editorIndentGuide.background\' is deprecated. Use \'editorIndentGuide.background1\' instead.'
)));
const deprecatedEditorActiveIndentGuides = registerColor('editorIndentGuide.activeBackground', editorWhitespaces, ( localize(661, 'Color of the active editor indentation guides.')), false, ( localize(
 662,
 '\'editorIndentGuide.activeBackground\' is deprecated. Use \'editorIndentGuide.activeBackground1\' instead.'
)));
const editorIndentGuide1 = registerColor('editorIndentGuide.background1', deprecatedEditorIndentGuides, ( localize(663, 'Color of the editor indentation guides (1).')));
const editorIndentGuide2 = registerColor('editorIndentGuide.background2', '#00000000', ( localize(664, 'Color of the editor indentation guides (2).')));
const editorIndentGuide3 = registerColor('editorIndentGuide.background3', '#00000000', ( localize(665, 'Color of the editor indentation guides (3).')));
const editorIndentGuide4 = registerColor('editorIndentGuide.background4', '#00000000', ( localize(666, 'Color of the editor indentation guides (4).')));
const editorIndentGuide5 = registerColor('editorIndentGuide.background5', '#00000000', ( localize(667, 'Color of the editor indentation guides (5).')));
const editorIndentGuide6 = registerColor('editorIndentGuide.background6', '#00000000', ( localize(668, 'Color of the editor indentation guides (6).')));
const editorActiveIndentGuide1 = registerColor('editorIndentGuide.activeBackground1', deprecatedEditorActiveIndentGuides, ( localize(669, 'Color of the active editor indentation guides (1).')));
const editorActiveIndentGuide2 = registerColor('editorIndentGuide.activeBackground2', '#00000000', ( localize(670, 'Color of the active editor indentation guides (2).')));
const editorActiveIndentGuide3 = registerColor('editorIndentGuide.activeBackground3', '#00000000', ( localize(671, 'Color of the active editor indentation guides (3).')));
const editorActiveIndentGuide4 = registerColor('editorIndentGuide.activeBackground4', '#00000000', ( localize(672, 'Color of the active editor indentation guides (4).')));
const editorActiveIndentGuide5 = registerColor('editorIndentGuide.activeBackground5', '#00000000', ( localize(673, 'Color of the active editor indentation guides (5).')));
const editorActiveIndentGuide6 = registerColor('editorIndentGuide.activeBackground6', '#00000000', ( localize(674, 'Color of the active editor indentation guides (6).')));
const deprecatedEditorActiveLineNumber = registerColor('editorActiveLineNumber.foreground', { dark: '#c6c6c6', light: '#0B216F', hcDark: activeContrastBorder, hcLight: activeContrastBorder }, ( localize(675, 'Color of editor active line number')), false, ( localize(
 676,
 'Id is deprecated. Use \'editorLineNumber.activeForeground\' instead.'
)));
registerColor('editorLineNumber.activeForeground', deprecatedEditorActiveLineNumber, ( localize(675, 'Color of editor active line number')));
const editorDimmedLineNumber = registerColor('editorLineNumber.dimmedForeground', null, ( localize(
 677,
 'Color of the final editor line when editor.renderFinalNewline is set to dimmed.'
)));
const editorRuler = registerColor('editorRuler.foreground', { dark: '#5A5A5A', light: Color.lightgrey, hcDark: Color.white, hcLight: '#292929' }, ( localize(678, 'Color of the editor rulers.')));
registerColor('editorCodeLens.foreground', { dark: '#999999', light: '#919191', hcDark: '#999999', hcLight: '#292929' }, ( localize(679, 'Foreground color of editor CodeLens')));
registerColor('editorBracketMatch.background', { dark: '#0064001a', light: '#0064001a', hcDark: '#0064001a', hcLight: '#0000' }, ( localize(680, 'Background color behind matching brackets')));
registerColor('editorBracketMatch.border', { dark: '#888', light: '#B9B9B9', hcDark: contrastBorder, hcLight: contrastBorder }, ( localize(681, 'Color for matching brackets boxes')));
const editorOverviewRulerBorder = registerColor('editorOverviewRuler.border', { dark: '#7f7f7f4d', light: '#7f7f7f4d', hcDark: '#7f7f7f4d', hcLight: '#666666' }, ( localize(682, 'Color of the overview ruler border.')));
const editorOverviewRulerBackground = registerColor('editorOverviewRuler.background', null, ( localize(683, 'Background color of the editor overview ruler.')));
registerColor('editorGutter.background', editorBackground, ( localize(
 684,
 'Background color of the editor gutter. The gutter contains the glyph margins and the line numbers.'
)));
registerColor('editorUnnecessaryCode.border', { dark: null, light: null, hcDark: ( ( Color.fromHex('#fff')).transparent(0.8)), hcLight: contrastBorder }, ( localize(685, 'Border color of unnecessary (unused) source code in the editor.')));
...
registerColor('editorGhostText.border', { dark: null, light: null, hcDark: ( ( Color.fromHex('#fff')).transparent(0.8)), hcLight: ( ( Color.fromHex('#292929')).transparent(0.8)) }, ( localize(687, 'Border color of ghost text in the editor.')));
const ghostTextForeground = registerColor('editorGhostText.foreground', { dark: ( Color.fromHex('#ffffff56')), light: ( Color.fromHex('#0007')), hcDark: null, hcLight: null }, ( localize(688, 'Foreground color of the ghost text in the editor.')));
registerColor('editorGhostText.background', null, ( localize(689, 'Background color of the ghost text in the editor.')));
...
const overviewRulerError = registerColor('editorOverviewRuler.errorForeground', { dark: ( new Color(( new RGBA(255, 18, 18, 0.7)))), light: ( new Color(( new RGBA(255, 18, 18, 0.7)))), hcDark: ( new Color(( new RGBA(255, 50, 50, 1)))), hcLight: '#B5200D' }, ( localize(691, 'Overview ruler marker color for errors.')));
const overviewRulerWarning = registerColor('editorOverviewRuler.warningForeground', { dark: editorWarningForeground, light: editorWarningForeground, hcDark: editorWarningBorder, hcLight: editorWarningBorder }, ( localize(692, 'Overview ruler marker color for warnings.')));
const overviewRulerInfo = registerColor('editorOverviewRuler.infoForeground', { dark: editorInfoForeground, light: editorInfoForeground, hcDark: editorInfoBorder, hcLight: editorInfoBorder }, ( localize(693, 'Overview ruler marker color for infos.')));
...
registerColor('editorUnicodeHighlight.border', editorWarningForeground, ( localize(713, 'Border color used to highlight unicode characters.')));
registerColor('editorUnicodeHighlight.background', editorWarningBackground, ( localize(714, 'Background color used to highlight unicode characters.')));
