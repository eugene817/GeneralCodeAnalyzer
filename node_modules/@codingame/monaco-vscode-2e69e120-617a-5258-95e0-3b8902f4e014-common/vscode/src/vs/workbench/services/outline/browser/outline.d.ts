...
import { IDataSource, ITreeRenderer } from "@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/tree/tree";
...
import { IWorkbenchDataTreeOptions } from "@codingame/monaco-vscode-api/vscode/vs/platform/list/browser/listService";
