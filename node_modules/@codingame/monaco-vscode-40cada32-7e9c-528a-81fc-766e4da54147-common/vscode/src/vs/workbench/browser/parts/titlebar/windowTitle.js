...
import { Verbosity as Verbosity$1 } from '@codingame/monaco-vscode-7559b0be-bfa5-5fe6-b731-1973fe9fffa1-common/vscode/vs/platform/label/common/label';
import { ILabelService } from '@codingame/monaco-vscode-api/vscode/vs/platform/label/common/label.service';
import { Emitter } from '@codingame/monaco-vscode-api/vscode/vs/base/common/event';
import { RunOnceScheduler } from '@codingame/monaco-vscode-api/vscode/vs/base/common/async';
import { IProductService } from '@codingame/monaco-vscode-api/vscode/vs/platform/product/common/productService.service';
import { Schemas } from '@codingame/monaco-vscode-api/vscode/vs/base/common/network';
import { getVirtualWorkspaceLocation } from '@codingame/monaco-vscode-7559b0be-bfa5-5fe6-b731-1973fe9fffa1-common/vscode/vs/platform/workspace/common/virtualWorkspace';
...
let WindowTitle = class WindowTitle extends Disposable {
    ...
    static { this.NLS_USER_IS_ADMIN = isWindows ? ( localize(3441, "[Administrator]")) : ( localize(3442, "[Superuser]")); }
    static { this.NLS_EXTENSION_HOST = ( localize(3443, "[Extension Development Host]")); }
