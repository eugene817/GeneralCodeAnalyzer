...
import { DocumentLineRangeMap, LineRangeMapping, DocumentRangeMap } from '@codingame/monaco-vscode-210e86a9-a91b-5273-b05d-390c776dde1f-common/vscode/vs/workbench/contrib/mergeEditor/browser/model/mapping';
import { TextModelDiffs, TextModelDiffState, TextModelDiffChangeReason } from './textModelDiffs.js';
import { leftJoin } from '@codingame/monaco-vscode-210e86a9-a91b-5273-b05d-390c776dde1f-common/vscode/vs/workbench/contrib/mergeEditor/browser/utils';
import { ModifiedBaseRange, ModifiedBaseRangeStateKind, ModifiedBaseRangeState } from '@codingame/monaco-vscode-210e86a9-a91b-5273-b05d-390c776dde1f-common/vscode/vs/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange';
...
let MergeEditorModel = class MergeEditorModel extends EditorModel {
    ...
    setInputHandled(baseRange, inputNumber, handled, tx) {
        ...
        this.undoRedoService.pushElement({
            ...
            label: ( localize(7470, "Set Input Handled")),
            redo() {
...
class MarkAsHandledUndoRedoElement {
    constructor(resource, mergeEditorModelRef, stateRef, input1Handled, input2Handled) {
        ...
        this.label = ( localize(7471, 'Undo Mark As Handled'));
