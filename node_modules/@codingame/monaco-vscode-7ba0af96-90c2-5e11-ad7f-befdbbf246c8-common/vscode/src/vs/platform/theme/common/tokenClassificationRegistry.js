    ...
    constructor() {
        ...
        this.tokenStylingSchema = {
            ...
            definitions: {
                style: {
                    type: 'object',
                    description: ( localize(2235, 'Colors and styles for the token.')),
                    properties: {
                        foreground: {
                            type: 'string',
                            description: ( localize(2236, 'Foreground color for the token.')),
                            format: 'color-hex',
                            default: '#ff0000'
                        },
                        background: {
                            type: 'string',
                            deprecationMessage: ( localize(2237, 'Token background colors are currently not supported.'))
                        },
                        fontStyle: {
                            type: 'string',
                            ...
                            defaultSnippets: [
                                { label: ( localize(2240, 'None (clear inherited style)')), bodyText: '""' },
                                { body: 'italic' },
                                { body: 'bold' },
                                { body: 'underline' },
                                { body: 'strikethrough' },
...
function createDefaultTokenClassificationRegistry() {
    ...
    registerTokenType('comment', ( localize(2245, "Style for comments.")), [['comment']]);
    registerTokenType('string', ( localize(2246, "Style for strings.")), [['string']]);
    registerTokenType('keyword', ( localize(2247, "Style for keywords.")), [['keyword.control']]);
    registerTokenType('number', ( localize(2248, "Style for numbers.")), [['constant.numeric']]);
    registerTokenType('regexp', ( localize(2249, "Style for expressions.")), [['constant.regexp']]);
    registerTokenType('operator', ( localize(2250, "Style for operators.")), [['keyword.operator']]);
    registerTokenType('namespace', ( localize(2251, "Style for namespaces.")), [['entity.name.namespace']]);
    registerTokenType('type', ( localize(2252, "Style for types.")), [['entity.name.type'], ['support.type']]);
    registerTokenType('struct', ( localize(2253, "Style for structs.")), [['entity.name.type.struct']]);
    registerTokenType('class', ( localize(2254, "Style for classes.")), [['entity.name.type.class'], ['support.class']]);
    registerTokenType('interface', ( localize(2255, "Style for interfaces.")), [['entity.name.type.interface']]);
    registerTokenType('enum', ( localize(2256, "Style for enums.")), [['entity.name.type.enum']]);
    registerTokenType('typeParameter', ( localize(2257, "Style for type parameters.")), [['entity.name.type.parameter']]);
    registerTokenType('function', ( localize(2258, "Style for functions")), [['entity.name.function'], ['support.function']]);
    registerTokenType('member', ( localize(2259, "Style for member functions")), [], 'method', 'Deprecated use `method` instead');
    registerTokenType('method', ( localize(2260, "Style for method (member functions)")), [['entity.name.function.member'], ['support.function']]);
    registerTokenType('macro', ( localize(2261, "Style for macros.")), [['entity.name.function.preprocessor']]);
    registerTokenType('variable', ( localize(2262, "Style for variables.")), [['variable.other.readwrite'], ['entity.name.variable']]);
    registerTokenType('parameter', ( localize(2263, "Style for parameters.")), [['variable.parameter']]);
    registerTokenType('property', ( localize(2264, "Style for properties.")), [['variable.other.property']]);
    registerTokenType('enumMember', ( localize(2265, "Style for enum members.")), [['variable.other.enummember']]);
    registerTokenType('event', ( localize(2266, "Style for events.")), [['variable.other.event']]);
    registerTokenType('decorator', ( localize(2267, "Style for decorators & annotations.")), [['entity.name.decorator'], ['entity.name.function']]);
    registerTokenType('label', ( localize(2268, "Style for labels. ")), undefined);
    registry.registerTokenModifier('declaration', ( localize(2269, "Style for all symbol declarations.")), undefined);
    registry.registerTokenModifier('documentation', ( localize(2270, "Style to use for references in documentation.")), undefined);
    registry.registerTokenModifier('static', ( localize(2271, "Style to use for symbols that are static.")), undefined);
    registry.registerTokenModifier('abstract', ( localize(2272, "Style to use for symbols that are abstract.")), undefined);
    registry.registerTokenModifier('deprecated', ( localize(2273, "Style to use for symbols that are deprecated.")), undefined);
    registry.registerTokenModifier('modification', ( localize(2274, "Style to use for write accesses.")), undefined);
    registry.registerTokenModifier('async', ( localize(2275, "Style to use for symbols that are async.")), undefined);
    registry.registerTokenModifier('readonly', ( localize(2276, "Style to use for symbols that are read-only.")), undefined);
