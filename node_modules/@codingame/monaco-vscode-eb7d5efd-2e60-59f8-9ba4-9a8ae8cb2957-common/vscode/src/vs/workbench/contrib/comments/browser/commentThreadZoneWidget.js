...
import { CommentThreadWidget } from '@codingame/monaco-vscode-a3f28a41-ba19-5a7e-8f5a-d6c1403b507d-common/vscode/vs/workbench/contrib/comments/browser/commentThreadWidget';
import { getCommentThreadStateBorderColor, commentThreadStateColorVar, commentThreadStateBackgroundColorVar } from '@codingame/monaco-vscode-a3f28a41-ba19-5a7e-8f5a-d6c1403b507d-common/vscode/vs/workbench/contrib/comments/browser/commentColors';
    ...
    async confirmCollapse() {
        ...
        if (confirmSetting === 'whenHasUnsubmittedComments' && this._commentThreadWidget.hasUnsubmittedComments) {
            const result = await this.dialogService.confirm({
                ...
                primaryButton: ( localize(5071, "Collapse")),
                type: Severity.Warning,
                checkbox: { label: ( localize(5072, "Never ask me again")), checked: false }
            });
